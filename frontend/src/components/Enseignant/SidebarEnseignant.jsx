...
const SidebarEnseignant = ({ isOpen, onClose, role = "enseignant" }) => {
    ...
    <>
      ...
      >
        ...
        <div className="p-3 mt-auto">
          {/* BLOC SWITCH TEMPORAIRE */}
          <div className="pt-3.5 border-t border-white/5 mb-1">
            <p className="text-[#3D5068] text-[10px] uppercase font-bold tracking-[0.08em] px-1 mb-2">
              MODE D'APERÇU
            </p>
            <div className="grid grid-cols-3 gap-1.5">
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-0.5 py-2 rounded-lg transition-all bg-white/[0.04] border border-white/5 text-[#7A8FAD] hover:bg-[#0097FB]/10 hover:text-[#0097FB]"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-0.5 py-2 rounded-lg transition-all bg-white/[0.04] border border-white/5 text-[#7A8FAD] hover:bg-[#7B2FBE]/10 hover:text-[#7B2FBE]"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-0.5 py-2 rounded-lg transition-all bg-gradient-to-br from-[#10B981] to-[#059669] text-white font-semibold cursor-default"
              >
                <MdSchool size={15} />
                <span className="text-[11px]">Ens.</span>
              </button>
            </div>
            <p className="text-[#3D5068] text-[10px] text-center mt-1.5 italic">
              Bascule temporaire — sans auth
            </p>
          </div>
